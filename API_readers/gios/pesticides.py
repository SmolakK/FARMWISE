...
def read_and_modify_csv(file_path, custom_headers, new_data, skip_until=70, num_rows=11):
...
def process_all_csv(data_directory, output_directory, custom_headers, new_data, skip_until=70, num_rows=11):
    ...
    output_path = os.path.join(output_directory, 'pesticides.csv')
...
new_data = ['organochlorine_pesticides_DDT/DDE/DDD [mg*kg-1]', 'organochlorine_pesticides_aldrin [mg*kg-1]',
            ...
            'pesticides_non_chlorinated_compounds_atrazin [mg*kg-1]']
