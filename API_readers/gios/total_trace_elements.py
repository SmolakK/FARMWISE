...
def read_and_modify_csv(file_path, custom_headers, new_data, skip_until=38, num_rows=16):
...
def process_all_csv(data_directory, output_directory, custom_headers, new_data, skip_until=38, num_rows=16):
    ...
    output_path = os.path.join(output_directory, 'total_trace_elements.csv')
...
new_data = ['Mn [mg*kg-1]', 'Cd [mg*kg-1]', 'Cu [mg*kg-1]', 'Cr [mg*kg-1]', 'Ni [mg*kg-1]', 'Pb [mg*kg-1]',
            'Zn [mg*kg-1]', 'Co [mg*kg-1]', 'V [mg*kg-1]', 'Li [mg*kg-1]', 'Be [mg*kg-1]', 'Ba [mg*kg-1]',
            'Sr [mg*kg-1]', 'La [mg*kg-1]', 'Hg [mg*kg-1]', 'As [mg*kg-1]']
