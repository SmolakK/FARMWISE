...
def read_and_modify_csv(file_path, custom_headers, new_data, skip_until=10, num_rows=4):
...
def process_all_csv(data_directory, output_directory, custom_headers, new_data, skip_until=10, num_rows=4):
    ...
    output_path = os.path.join(output_directory, 'soil_organics.csv')
...
new_data = ['humus [%]', 'organic_carbon [%]', 'total_nitrogen [%]', 'c/n [-]']
