...
def read_data(spatial_range, time_range, data_range, level):
    ...
    north, south, east, west = spatial_range  # Christchurch example
    how_many_cells = how_many(north, south, east, west, level)
    ...
    for soil_property in data_requested:
        ...
        data = soilgrids.get_coverage_data(service_id=soil_property,
                                           ...
                                           width=how_many_cells,  # Resolution - adjust as needed
                                           height=how_many_cells,
    ...
    latitudes = np.linspace(south, north, how_many_cells)
    longitudes = np.linspace(west, east, how_many_cells)
